...
public class EdgeDetection : ScriptableRendererFeature
{
	...
	// Material is now exposed to the inspector.
	...
	public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
	{
		...
		// If no material was assigned in the inspector, try to create one.
	...
	override protected void Dispose(bool disposing)
	{
		...
		// Only destroy the material if it was not assigned externally.
